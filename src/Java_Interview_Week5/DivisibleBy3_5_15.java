...
public class DivisibleBy3_5_15 {
    ...
    */
      ...
      public void solution(int n){
          ...
          int[] arr = new int[n];
          for(int i=0; i<arr.length; i++){ // could have used: i = 1 and delete < arr[i] = i + 1 >
              arr[i] = i + 1;
          }
          for(int each: arr){
          ...
          /*
          == is a reference comparison, i.e. both variables point to the same memory location
